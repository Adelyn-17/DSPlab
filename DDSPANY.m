...
% a_values = [2, 3, 4];             % Coarse version if needed
...
for idx = 1:length(a_values)
    ...
    % Crop to original reference size (in case of border effects)
